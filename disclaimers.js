document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            disclaimer8: "Disclaimer on Client Retention and Satisfaction Metrics: The metrics related to client retention and satisfaction referenced on this website are based on internal assessments conducted from 2019 to the present. The client retention rate is derived from a group of approximately 200 clients who chose to continue their relationship with our team during this period. Similarly, the client satisfaction metric is based on feedback from approximately 200 clients who expressed satisfaction with the services received. These figures are intended to provide a general indication of historical performance and client experience but may not be representative of all clients. Individual experiences may vary.",
            disclaimer9: "Imran Mastan is a registered representative of Designed Securities Ltd."
        },
        fr: {
            ...
            disclaimer8: "Avis de non-responsabilité sur les métriques de rétention et de satisfaction des clients : Les métriques relatives à la rétention et à la satisfaction des clients mentionnées sur ce site web sont basées sur des évaluations internes menées de 2019 à aujourd'hui. Le taux de rétention des clients est calculé à partir d'un groupe d'environ 200 clients qui ont choisi de poursuivre leur relation avec notre équipe durant cette période. De même, la métrique de satisfaction des clients est basée sur les commentaires d'environ 200 clients ayant exprimé leur satisfaction à l'égard des services reçus. Ces chiffres visent à donner une indication générale de la performance historique et de l'expérience client, mais peuvent ne pas être représentatifs de tous les clients. Les expériences individuelles peuvent varier.",
            disclaimer9: "Imran Mastan est un représentant inscrit de Designed Securities Ltée."
        }
    };
